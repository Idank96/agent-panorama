...
const TWEAKS_STYLE = `
  .twk-fab{position:fixed;right:16px;bottom:16px;z-index:2147483645;
    appearance:none;height:36px;padding:0 14px;border-radius:999px;
    border:.5px solid rgba(0,0,0,.12);background:rgba(250,249,247,.92);
    color:#29261b;font:600 12px/1 ui-sans-serif,system-ui,-apple-system,sans-serif;
...
export function TweakSelect({ label, value, options, onChange }: RadioProps) {
  return (
    <TweakRow label={label}>
      <select
        className="twk-field"
...
/**
 * Floating Tweaks shell. A FAB toggles the panel; the panel header is draggable
 * and clamps to the viewport. State lives in the parent — this component only
 * owns open/closed and position.
 */
